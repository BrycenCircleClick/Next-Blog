    ...
    <div className="flex flex-col w-screen items-stretch overflow-hidden">
      ...
      <div className="flex grow flex-col items-stretch max-md:max-w-full ">
        <img
          ...
          className=" object-contain object-center w-full   max-md:max-w-full"
          alt=""
        />
      </div>
      <LearnToday
